...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Gzip_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("be1be57a-8558-53c3-a7e5-50095f79957e"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Gzip", artifacts_toml) for e in artifacts["Gzip"]]
...
if best_platform === nothing
    @debug("Unable to load Gzip; unsupported platform $(triplet(platform_key_abi()))")
else
